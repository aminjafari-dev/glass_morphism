...
import 'liquid_glass_page.dart';

class GlassHome extends StatefulWidget {
  const GlassHome({super.key, this.liquid = false});
  final bool liquid;
  @override
...
class _GlassHomeState extends State<GlassHome> {
  ...
  @override
  Widget build(BuildContext context) => LiquidGlassScope(
    enabled: widget.liquid,
    child: Scaffold(
      body: Stack(
        children: [
              ...
              builder: (context, constraints) => SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextButton.icon(
                      onPressed: () => widget.liquid
                          ? Navigator.of(context).pop()
                          : Navigator.of(context).push(
                              MaterialPageRoute<void>(
                                builder: (_) => const LiquidGlassPage(),
                              ),
                            ),
                      icon: Icon(
                        widget.liquid
                                ...
                                (index) => Expanded(
                                  child: Padding(
                                    ...
                                    child: GestureDetector(
                                      onTap: () =>
                                          setState(() => scene = index),
                                      child: widget.liquid
                                          ? LiquidGlass(
                                              radius: 30,
                                              tone: scene == index ? 1 : 0,
                                              child: Padding(
                                                padding:
...
class Glass extends StatelessWidget {
  ...
  final double radius;
  @override
  Widget build(BuildContext context) => LiquidGlassScope.of(context)
      ? LiquidGlass(radius: radius, child: child)
      : Container(
          decoration: BoxDecoration(
